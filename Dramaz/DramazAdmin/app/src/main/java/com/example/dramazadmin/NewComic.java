...
public class NewComic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_comic);
        name=findViewById(R.id.Cname);
        lurl=findViewById(R.id.CImageurl);
        url=findViewById(R.id.CPdfurl);
        upload=findViewById(R.id.Cupload);
    ...
    void vupload(String nm,String Lurl,String Url) {
        ...
        databaseReference.child(databaseReference.push().getKey()).setValue(obj).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                Toast.makeText(NewComic.this, "upload successfull", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(NewComic.this, "upload failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
}